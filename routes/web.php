...
Route::group(['middleware' => ['guest:admin', 'guest:anggota']], function () {
    ...
    // Auth Petugas
    Route::get('petugas/login', [PetugasAuthController::class, 'getlogin'])->name('petugas-login');
    Route::get('petugas/login', [PetugasAuthController::class, 'authenticate'])->name('petugas-authenticate');
});
